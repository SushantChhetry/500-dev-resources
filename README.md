...
- [Official documentation for Ada](https://learn.adacore.com/)
- [Official documentation for Elixir](https://hexdocs.pm/elixir/)
- [Official documentation for Erlang](https://www.erlang.org/docs)
- [Official documentation for Hadoop](https://hadoop.apache.org/docs/stable/)
- [Official documentation for Apache Spark](https://spark.apache.org/docs/latest/)
- [Official documentation for Angular](https://angular.io/docs)
- [Official documentation for React](https://reactjs.org/docs)
- [Official documentation for Vue.js](https://v3.vuejs.org/guide/introduction.html)
- [Official documentation for Ember.js](https://guides.emberjs.com/release/)
- [Official documentation for Django](https://docs.djangoproject.com/)
- [Official documentation for Express.js](https://expressjs.com/)
- [Official documentation for Ruby on Rails](https://guides.rubyonrails.org/)
- [Official documentation for Spring Framework](https://spring.io/docs)
- [Official documentation for Hibernate](https://hibernate.org/orm/documentation/)
- [Official documentation for ASP.NET](https://docs.microsoft.com/en-us/aspnet/)
- [Official documentation for Laravel](https://laravel.com/docs)
- [Official documentation for CodeIgniter](https://codeigniter.com/user_guide/)
- [Official documentation for Node.js](https://nodejs.org/en/docs/)
- [Official documentation for GraphQL](https://graphql.org/learn/)
- [Official documentation for Apache Kafka](https://kafka.apache.org/documentation/)
- [Official documentation for Amazon Web Services](https://docs.aws.amazon.com/)
- [Official documentation for Google Cloud Platform](https://cloud.google.com/docs)
- [Official documentation for Microsoft Azure](https://docs.microsoft.com/en-us/azure/)
- [Official documentation for Docker](https://docs.docker.com/)
- [Official documentation for Kubernetes](https://kubernetes.io/docs/)
- [Official documentation for Apache HBase ](https://hbase.apache.org/book.html)
- [Official documentation for Apache Cassandra](https://cassandra.apache.org/doc/latest/)
- [Official documentation for MongoDB](https://docs.mongodb.com/)
- [Official documentation for Redis](https://redis.io/documentation)
...
- [Official documentation for SQLite](https://www.sqlite.org/docs.html)
- [Official documentation for Apache Lucene](https://lucene.apache.org/core/documentation.html)
- [Official documentation for Apache Solr](https://solr.apache.org/guide/)
- [Official documentation for TensorFlow](https://www.tensorflow.org/guide)
- [Official documentation for PyTorch](https://pytorch.org/docs/stable/)
- [Official documentation for scikit-learn](https://scikit-learn.org/stable/documentation.html)
- [Official documentation for NumPy](https://numpy.org/doc/)
- [Official documentation for pandas ](https://pandas.pydata.org/docs/)
- [Official documentation for matplotlib ](https://matplotlib.org/stable/contents.html)
- [Official documentation for seaborn ](https://seaborn.pydata.org/tutorial.html)
- [Official documentation for OpenCV ](https://docs.opencv.org/)
- [Official documentation for Unity](https://docs.unity3d.com/Manual/index.html)
- [Official documentation for Unreal Engine ](https://docs.unrealengine.com/en-US/index.html)
- [Official documentation for Flutter](https://flutter.dev/docs)
- [Official documentation for React Native](https://reactnative.dev/docs)
- [Official documentation for Electron](https://www.electronjs.org/docs)
- [Official documentation for Backbone.js](https://backbonejs.org/)
- [Official documentation for Knockout.js](https://knockoutjs.com/documentation/introduction.html)
- [Official documentation for Redux](https://redux.js.org/)
- [Official documentation for Apache NiFi](https://nifi.apache.org/docs.html)
- [Official documentation for Apache Beam ](https://beam.apache.org/documentation/)
- [Official documentation for Apache Flink](https://flink.apache.org/docs/)
- [Official documentation for Apache Storm](https://storm.apache.org/documentation.html)
- [Official documentation for Apache Camel](https://camel.apache.org/manual/latest/index.html)
- [Official documentation for Apache CXF](https://cxf.apache.org/docs/)
- [Official documentation for Sinatra ](http://sinatrarb.com/documentation.html)
- [Official documentation for Flask ](https://flask.palletsprojects.com/)
- [Official documentation for Pyramid](https://docs.pylonsproject.org/projects/pyramid/en/latest/)
- [Official documentation for Laravel ](https://laravel.com/docs)
- [Official documentation for CodeIgniter ](https://codeigniter.com/user_guide/)
- [Official documentation for Symfony](https://symfony.com/doc/current/index.html)
- [Official documentation for ASP.NET ](https://docs.microsoft.com/en-us/aspnet/)
- [Official documentation for NestJS ](https://docs.nestjs.com/)
- [Official documentation for Next.js](https://nextjs.org/docs)
- [Official documentation for Svelte ](https://svelte.dev/docs)
- [Official documentation for RubyGems ](https://guides.rubygems.org/)
- [Official documentation for CocoaPods](https://guides.cocoapods.org/)
- [Official documentation for NPM ](https://docs.npmjs.com/)
- [Official documentation for Yarn ](https://yarnpkg.com/getting-started)
- [Official documentation for Apache Maven](https://maven.apache.org/guides/)
- [Official documentation for Gradle](https://docs.gradle.org/current/userguide/userguide.html)
- [Official documentation for Apache Ant ](https://ant.apache.org/manual/)
- [Official documentation for Make ](https://www.gnu.org/software/make/manual/make.html)
- [Official documentation for Git ](https://git-scm.com/doc)
- [Official documentation for Mercurial](https://www.mercurial-scm.org/guide)
- [Official documentation for SVN ](https://subversion.apache.org/docs/)
- [Official documentation for Perforce](https://www.perforce.com/manuals)
- [Official documentation for Jira](https://support.atlassian.com/jira-software-cloud/docs/get-started-with-jira-software-cloud/)
- [Official documentation for Trello](https://help.trello.com/)
- [Official documentation for Jenkins ](https://www.jenkins.io/doc/)
- [Official documentation for CircleCI ](https://circleci.com/docs/)
- [Official documentation for Travis CI ](https://docs.travis-ci.com/)
- [Official documentation for Selenium ](https://www.selenium.dev/documentation/)
- [Official documentation for Cypress](https://docs.cypress.io/)
- [Official documentation for JUnit ](https://junit.org/junit5/docs/current/user-guide/)
- [Official documentation for pytest ](https://docs.pytest.org/en/latest/)
- [Official documentation for Mocha](https://mochajs.org/)
- [Official documentation for Jasmine](https://jasmine.github.io/)
- [Official documentation for Protractor ](https://www.protractortest.org/#/docs)
- [Official documentation for Mockito ](https://javadoc.io/doc/org.mockito/mockito-core/latest/org/mockito/Mockito.html)
- [Official documentation for Chai ](https://www.chaijs.com/api/)
...
- YK aka CS Dojo - [@ykdojo](https://twitter.com/ykdojo)
- GrahamTheDev - [@GrahamTheDev](https://twitter.com/GrahamTheDev)
- Arya AI Dojo - [@arya_akhare](https://twitter.com/arya_akhare)
- Avie Fukai - [@AvieDev](https://twitter.com/AvieDev)
